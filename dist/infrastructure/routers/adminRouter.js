...
const adminRoutes = (dependencies) => {
    const { loginAdmin, addVerifiedUser, getVerifiedUsers, DeleteVerifiedUser, loginUser, AddCourse, getCourse, getCoursebyId } = (0, controllers_1.adminController)(dependencies);
